      ...
      <Link to={`/product/${product.slug}`} className="relative block overflow-hidden">
        <figure className="aspect-4/3 bg-base-300">
          {product.imageUrl ? (
            ...
            <div className="flex h-full w-full items-center justify-center bg-linear-to-br from-base-200 to-base-300 text-xs font-medium uppercase tracking-[0.2em] text-base-content/40">
              No image
            </div>
          )}
        </figure>
