...
import { useAdminProductsPage } from '../Hooks/useAdminProducts'
...
import {AdminProductForm} from '../components/AdminProductsForm';
...
function AdminProductsPage() {
    ...
    function handleDeleteProduct(product) {
        if (!window.confirm(`Delete "${product.name}" pemanently`)) return;
    ...
    return (
        <div className='text-left'>
            ...
            {isLoading ? (<AdminProductsTableSkeleton />) : (
