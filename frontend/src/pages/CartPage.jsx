  ...
  return (
    <div className="text-left">
      ...
      {items.length === 0 ? (
        ...
        <>
          <PageError message="Could not load product details. Refresh the page and try again." />
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_320px]">
          ...
          <aside className="card border border-base-300 bg-base-100 p-6 shadow-md">
            <div className="flex justify-between text-sm">
              ...
              <span>{formatPrice(subtotal, lines[0]?.product?.currency ?? "INR")}</span>
            </div>
            ...
            {checkoutError ? <PageError message={checkoutError} /> : null}
